            ...
            <header className={styles.gameHeader}>
                ...
                {!gameOver && (
                    <div className={styles.instructionPanel}>
                        <h2>Pecahkan Balon Huruf: <span className={styles.targetLetter}>{targetLetter}</span> <span style={{ fontSize: '1.2rem', color: 'var(--cat-blue)' }}>({poppedCount}/{currentTargetCount})</span></h2>
                        <button
                ...
                {gameOver ? (
                    <div className={styles.gameOverPanel}>
                        ...
                        <div style={{ marginTop: '20px' }}>
                            ...
                            <Link to="/alfabet" className="btn" style={{ backgroundColor: 'var(--cat-green)' }}>
                                Menu Alfabet 🔠
                            </Link>
                        </div>
                    </div>
