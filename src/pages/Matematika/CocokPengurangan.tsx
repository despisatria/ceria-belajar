...
const CocokPengurangan: React.FC = () => {
    ...
    const triggerConfetti = useCallback(() => {
        confetti({
            ...
            spread: 80,
            origin: { y: 0.6 },
            colors: ['#F97316', '#FB923C', '#FDBA74', '#FCD34D', '#10B981']
        });
    }, []);
    ...
    const getCardStyle = (isMatched: boolean, isSelected: boolean, isWrong: boolean, isCorrectFlash: boolean, isReady: boolean): React.CSSProperties => ({
        ...
        boxShadow: isSelected ? '0 0 0 3px rgba(249,115,22,0.25)' : 'none',
        letterSpacing: '1px',
    });
                ...
                <div className={styles.headerTop}>
                    ...
                    <div className={styles.statsPanel}>
                        ...
                        <div className={styles.statBox}>
                            ...
                            <span className={styles.statValue} style={{ color: 'var(--cat-orange)' }}>{Math.min(round, TOTAL_ROUNDS)}/5</span>
                        </div>
                    </div>
                </div>
                <h2 className={styles.gameTitle} style={{ color: 'var(--cat-orange)' }}>Cocokkan Pengurangan 🔗</h2>
...
export default CocokPengurangan;
